...
def create_pdf(request,  pk: int):
    ...
    h1 { font-family: 'ui-sans-serif';
     ...
     response['Content-Disposition'] = 'inline; filename="{}.pdf"'.format(f'ememo_{pk}')
     return response
...
def create_pdf_email(request,  pk: int):
    ...
    html_content = render_to_string('ememo/Emails/ememo_email.html',  {'object':object, 'qr_code_image_data': qr_code_image_data })
